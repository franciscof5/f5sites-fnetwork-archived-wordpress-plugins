            ...
            if (isset($getallresults)) {
                foreach ($getallresults as $allvalue) {                    
                    if ($allvalue['pointstoencash'] != '' ) {
                        $mainlistarray_alldata_heading = "User Name,Points for Cash Back, Currency Code, Amount for Cash Back,Reason for Encashing,Paypal Address, Other Payment Details,Application Status,Cash Back Requested Date" ."\n";
