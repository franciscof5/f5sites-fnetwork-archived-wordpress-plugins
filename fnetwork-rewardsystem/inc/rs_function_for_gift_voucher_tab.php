    ...
    <?php
        if (isset($_POST['rs_export_gift_voucher_csv'])) {
            ...
            foreach($get_list_of_coupons as $each_coupon){
                ...
                header("Content-Disposition: attachment; filename=reward_points_gift_voucher" . date("Y-m-d") . ".csv");
                                        ...
                                        if(($restrictuserpoints != '') && ($restrictuserpoints != '0')){
                                            ...
                                            if($getoldpoints <= $restrictuserpoints){
                                                ...
                                                if($totalpointss <= $restrictuserpoints){
                                                    ...
                                                    RSPointExpiry::insert_earning_points(get_current_user_id(), $insertpoints,$pointsredeemed,$date,'MREPFU',$order_id,$totalearnedpoints,$totalredeempoints,'');
