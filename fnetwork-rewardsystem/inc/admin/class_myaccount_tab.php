    ...
    public static function reward_system_admin_fields() {
         ...
         return apply_filters('woocommerce_rewardsystem_myaccount_settings', array(
            ...
            array(
                ...
                . '[rs_my_rewards_log] - Use this Shortcode for displaying the log of Reward Points <br><br> [rs_my_reward_points] - Use this Shortcode for displaying the Reward Points of Current User <br><br>'
                .'[rs_generate_static_referral] - Use this Shortcode for displaying the Static URL Link<br><br>'
                .'[rs_my_cashback_log] - Use this Shortcode for displaying the My CashBack Table<br><br>'
                .'[rs_user_total_redeemed_points] - Use this Shortcode for displaying the total points Redeemed by a User<br><br>'
                .'[rs_user_total_earned_points] - Use this Shortcode for displaying the total points Earned by a User<br><br>'
                . '[rs_user_total_expired_points] - Use this Shortcode for displaying the total points Expired by a User</h3>'
            ),            
            array(
