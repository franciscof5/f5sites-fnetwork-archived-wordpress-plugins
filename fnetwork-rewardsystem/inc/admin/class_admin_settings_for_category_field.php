...
<div class="form-field">
            <label for="enable_point_price_category"><?php _e('Enable Point Purchase for  Product ', 'rewardsystem'); ?></label>
  ...
  <div class="form-field">
            <label for="rs_category_points_price"><?php _e(' Points Price', 'rewardsystem'); ?></label>
  ...
  <tr class="form-field">
               <th scope="row" valign="top"><?php _e(' Points Price', 'rewardsystem'); ?></label></th>
                 <td>
