        ...
        $particularcategory = get_terms('product_cat');        
         ...
         return apply_filters('woocommerce_rewardsystem_cart_settings', array(
            ...
            array(
                ...
                'type' => 'select',
                'options'=>array(
                    '1' => __('Based On Cart Subtotal', 'rewardsystem'),
                    '2' => __('Based On Product Total', 'rewardsystem'),
                ),
                'desc_tip' => true,
            ),            
            array(
            ...
            array(
                'name' => __('Enable Only Redeeming for Order', 'rewardsystem'),
                'desc' => __('Enable Only Redeeming for Order', 'rewardsystem'),
