    ...
    public static function reward_system_social_likes_buttons() {
        ...
        ?>
                ...
                jQuery.post("<?php echo admin_url('admin-ajax.php'); ?>", dataparam,
                        function (response) {
                            if (response == "You already Shared this post on Goole+1 Ajax Call Successfully Triggered") {
        ...
        if ($enablerewards == 'yes') {
            ...
            <?php if (get_option('rs_global_show_hide_twitter_tweet_button') == '1') { ?>                      
                        <td><a href="https://twitter.com/share" class="twitter-share-button" id="twitter-share-button" data-url="<?php echo get_option('rs_global_social_twitter_url') == '1' ? get_permalink() : get_option('rs_global_social_twitter_url_custom'); ?>"></a></td>
                    <?php } ?>
                    ...
                    <?php if (get_option('rs_global_show_hide_google_plus_button') == '1') { ?>
                        <td>
                            <div id="google-plus-one"><g:plusone annotation="bubble" class="google-plus-one" href='<?php echo get_option('rs_global_social_google_url') == '1' ? get_permalink() : get_option('rs_global_social_google_url_custom'); ?>' callback="originalCallback"></g:plusone></div>
                        </td>
            <?php } ?>                
            </tr>                 
            </table>
        ...
        ?>
                    ...
                    jQuery.post("<?php echo admin_url('admin-ajax.php'); ?>", dataparam,
                            function (response) {
                                ...
                                if (response == "You already Tweet this post Ajax Call Successfully Triggered") {
